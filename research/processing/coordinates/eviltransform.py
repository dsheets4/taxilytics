#!/usr/bin/env python
# -*- coding: utf-8 -*-
# From: https://github.com/googollee/eviltransform/blob/master/python/eviltransform.py
...
def gcj2wgs_exact(gcjLat, gcjLng, max_iterations=30, threshold=0.0000001, initDelta=0.01):
    dLat = dLng = initDelta
    mLat = gcjLat - dLat
    mLng = gcjLng - dLng
    pLat = gcjLat + dLat
